...
const Page = () => {
  ...
  const [selectedGroup, setSelectedGroup] = useState<GroupRequestUpdate | null>(
    null
  );
  ...
  const {
    ...
    onOpen: onOpenUpdateSchedule,
  } = useDisclosure();

  const stablePensumIds = useMemo(
    () => [...selectedPensumsIds],
    [selectedPensumsIds]
  );
