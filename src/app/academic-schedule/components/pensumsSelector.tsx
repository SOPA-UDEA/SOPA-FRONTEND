...
import { Button, Checkbox, Form, RadioGroup, Radio, CheckboxGroup } from "@heroui/react";
...
export default function PesnumSelector({ setSelectedPensumsIds, onOpenChange, onOpenSchedule, setAction, action, isFromDrai }: Props) {
    ...
    return (
        <Form onSubmit={handleSubmit}>
            ...
            <Button type='submit'
                color="secondary">Continuar</Button>
        </Form>
    )
} 