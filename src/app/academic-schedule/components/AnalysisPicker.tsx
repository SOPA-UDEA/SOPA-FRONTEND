import { Checkbox, CheckboxGroup, ModalBody, ModalFooter, ModalHeader, Button, ModalContent } from "@heroui/react"
            ...
            <ModalContent>
                {() => (
                    <form onSubmit={handleSubmit}>
                        <ModalHeader>Seleccione los análisis que desea ejecutar</ModalHeader>
                        <ModalBody>
                            <CheckboxGroup
                                        ...
                                        <Tooltip
                                            content={
                                                <div className="max-w-xs">
                                                    ...
                                                    <div className="text-sm text-gray-700">{tooltipDescription}</div>
                                                </div>
                                            }
                                            placement="right"
                                            delay={100}
